...
<html>
	...
	<body style="background-color: #fb8721;padding: 200px 0px 0px 500px;">
	
	
	<form action="./php/client_login.php" method="post">
	<img src="./Images/google_toolbar.jpg" id="toolbarlogo">
	<input id="user" type="text" name="user_name" required="required" placeholder="name" style="left: 600px; top: 325px; position: absolute; text-align: left; color: #fb8721; background-color: white; font-family: 'Lato', sans-serif; font-size: 16px; float: left;"><br/>
	<input id="password" type="password" name="password_name" required="required" placeholder="password" style="left: 780px; top: 325px; position: absolute; background-color: white; color: #fb8721; font-family: 'Lato', sans-serif; font-size: 16px; float: left;">

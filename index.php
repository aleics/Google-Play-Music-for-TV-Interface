...
<html>
	...
	<input id="androididinput"  name="android_id" required="required" placeholder="Android ID" style="left: 850px; top: 325px; position: absolute; background-color: white; color: #fb8721; font-family: 'Lato', sans-serif; font-size: 16px; float: left;">
